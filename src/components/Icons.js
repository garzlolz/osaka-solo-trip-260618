...
const makeIcon = (innerHTML, strokeWidth = "2") => ({
  render() {
    return h("svg", {
...
export const TrainIcon = makeIcon(
  '<rect x="4" y="3" width="16" height="16" rx="2"/><line x1="8" y1="19" x2="6" y2="23"/><line x1="16" y1="19" x2="18" y2="23"/><line x1="4" y1="11" x2="20" y2="11"/><circle cx="8.5" cy="15.5" r="1.5"/><circle cx="15.5" cy="15.5" r="1.5"/>'
);

export const PlaneIcon = makeIcon(
  '<path d="M17.8 19.2 16 11l3.5-3.5C21 6 21 4 19 4s-2 1-3.5 2.5L8 10 1.2 8.2C.7 8.1.3 8.6.5 9L3 16l5-2 2 5 .5-.5 2-5Z"'
);
