...
| 23:30 左右 | 抵達 [東橫INN大阪日本橋文樂劇場前](https://maps.app.goo.gl/fTt5JfTcHRqiNL1A8) 辦理入住 | 視出關與等車時間而定<br>✔ 預訂確認碼：5581.***.*** (PIN: ****)                                                                                                        |            |
...
* **託運行李**：1 件 (S*** H******* 加購 1 件)
* **聯絡人資訊**：H*** Y******* / 信箱 `i***@gmail.com` / 電話 `0928***397`
...
| 15:00–18:00 | **[難波](https://maps.app.goo.gl/6BJv4MGhXyZNv2daA)百貨大採購**                                                                                                      | 步行至 [高島屋](https://maps.app.goo.gl/FZJJxx5jNE9AviDo6)、[Namba Parks](https://maps.app.goo.gl/ZfReR9W9E2CEvvZ2A) 或 [難波CITY 本館](https://maps.app.goo.gl/Lst1Jbs3hmwBf7577)，亦可順道前往 [Edion 愛電王 難波總店](https://maps.app.goo.gl/4bxavCUCPaJaqNo16) 採購模型或電器。⚠️ 請預留充足的退稅手續時間 | 專櫃退稅、日系服飾、電器模型採購 |
